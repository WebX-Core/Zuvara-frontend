...
const ClothingProductDetailPage = () => {
  ...
  const defaultDesc = `Our ${selectedVariant?.name || product.name} collection uses only the finest breathable fabrics. Every seam is finished to be gentle against delicate skin, ensuring your little one can move freely and comfortably all day long.`;
                  ...
                  <div className="space-y-3 text-zinc-600 text-sm lg:text-base leading-relaxed">
                    ...
                    <AnimatePresence>
                      {showFullDescription && (
                        ...
                        >
                          <p>
                            Every seam is finished to be gentle against delicate
                            skin, ensuring your little one can move freely and
                      ...
                      <div className="text-zinc-500 text-xs md:text-sm lg:text-xl lg:leading-relaxed font-medium space-y-3">
                        ...
                        <AnimatePresence>
                          {showFullDescription && (
                            ...
                            >
                              <p>
                                Every seam is finished to be gentle against
                                delicate skin, ensuring your little one can move
