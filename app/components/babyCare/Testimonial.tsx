        ...
        <div className="rounded-4xl py-5 sm:px-4 md:py-6">
          ...
          <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="50" viewBox="0 0 512 168">
          ...
          <Swiper
            ...
            onSwiper={(swiper) => {
              // Re-init navigation after refs are bound
              setTimeout(() => {
              ...
              <SwiperSlide key={item.id}>
                ...
                >
                  ...
                  <div className="mt-5 flex flex-col items-center gap-3">
                    ...
                    <div>
                      <p className="text-base font-semibold md:text-lg" style={{ color: palette.accent }}>
                        {item.name}
                      </p>
                    ...
                    <div className="flex min-w-72 justify-between">
                      <span
                        ...
                        style={{ backgroundColor: "#e5e7eb", color: palette.accentSoft }}
                      >
                        {item.badge}
                      </span>
                  ...
                  <p className="mt-5 text-base leading-relaxed md:text-lg" style={{ color: palette.body }}>
                    {item.text}
                  </p>
